            ...
            <div className='grid items-center w-full max-w-2xl lg:text-center'>
                ...
                <div className='grid items-center grid-cols-3 gap-7 xl:gap-3'>
                    {experience?.map((val, i) => (
                        <div key={i} className="bg-gradient-to-b from-purple-300 to-grey-100 shadow-lg shadow-purple-200 flex items-center justify-center flex-col py-7 px-5 xl:p-5 rounded-lg text-slate-900 filter cursor-pointer hover:scale-105 transition-all duration-400">
